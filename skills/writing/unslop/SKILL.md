---
name: unslop
description: Cut AI tells from any writing. Load it before writing prose for a person: a reply, a commit message, a PR description, a doc, a report. Always applies.
---
...
Vendored from [poteto/pstack](https://github.com/cursor/plugins/tree/main/pstack)
(Lauren Tan, MIT). Local change: `disable-model-invocation` removed so an agent can load
this on its own, since it has to apply to every piece of writing and not only to an
